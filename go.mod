...
require (
	...
	github.com/zanmato1984/clickhouse v1.3.3
	github.com/zhexuany/parser v0.0.0-20190110092558-8feec731add9
...
replace github.com/pingcap/parser => github.com/zhexuany/parser v0.0.0-20190116044502-2c4dfb77b6fa
